...
export default function Breadcrumbs( props ) {
  ...
  useEffect( () => {
    ...
    if ( companyID ) {
      ...
      result.push( {
        link: "listItemsInCategory",
        label: company ? company.label : "All companies",
        args: {
          companyID: company ? company._id : "all-companies",
          categoryID: "all-categories"
        }
      } );
    }
    ...
    if ( match.path.includes( "manuals" ) ) {
      result.push( {
        link: "manuals",
        label: "Manuals",
        args: {
    ...
    if ( categoryID ) {
      ...
      result.push( {
        ...
        args: {
          companyID: !companyID ? "all-companies" : companyID,
          categoryID
        }
      } );
